...
public abstract class Building
{
    ...
    public List<Villager> Staff { get; } = new();
    public ResourceCost BuildCost { get; }
    public ResourceCost MaintenanceCost { get; }

    protected Building(string name, string description, int durability, int staffCapacity, ResourceCost buildCost,
        ResourceCost maintenanceCost)
    {
        Name = name;
